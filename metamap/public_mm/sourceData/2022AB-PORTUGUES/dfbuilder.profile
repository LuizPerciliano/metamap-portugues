...
CUSTOM_TAG=2022AB-PORTUGUES
export CUSTOM_TAG
SUBSET=2022AB-PORTUGUES
export SUBSET
KSYear=2022
export KSYear
CURR_YEAR_4=2022
export CURR_YEAR_4
CURR_RELEASE_LEVEL=AB
export CURR_RELEASE_LEVEL
DATA_VERSION=USAbase
export DATA_VERSION
DATA_YEAR=2022AB
export DATA_YEAR
MODEL=strict
export MODEL
# NOTE: MODELOPTION is currently not supported in filter_mrconso and mm_variants
MODELOPTION=--strict_model
export MODELOPTION
LEXICON_FLAT_FILE=/home/luizperciliano/metamap-portugues/metamap/public_mm/lexicon/data/lexiconStatic2020
export=LEXICON_FLAT_FILE

# end of dfbuilder.profile
