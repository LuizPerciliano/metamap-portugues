...
# ADD pruning, NLM, USAbase, and Base models, composite phrases, pruning, apostrophe-s, UDAs
...
METAMAP_PROD="metamap11 -V USAbase"

# Set METAMAP_TEST here!!
# METAMAP_TEST is the new development version to be tested
# METAMAP_TEST="SKRrun.11 ~/specialist/SKR/src/a.out.Linux"
METAMAP_TEST="/home/luizperciliano/metamap-portugues/metamap/public_mm/bin/metamap11"
...
apostrophe_s_contraction|--apostrophe_s_contraction|--apostrophe_s_contraction|apostrophe_s_contraction|0|
...
ignore_word_order|-i|-i|Ignore Word Order|0|
ignore_word_order_term_processing|-ai|-ai|Ignore Word Order Term Processing|0|
machine_output_CUIs|-qI|-qI|Machine Output, CUIs|1|
machine_output|-q|-q|Machine Output|1|
no_hide_semantic_types|||No Hide Semantic Types|0|
no_truncate_mappings|-b|-b|No Truncate Candidates Mappings|0|
...
yes_truncate_mappings|-bX|-bX|Yes Truncate Candidates Mappings|0|
